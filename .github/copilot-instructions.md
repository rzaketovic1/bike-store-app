...
\- Follow official naming convention: See [Unit Test Naming Convention](../docs/UNIT_TEST_NAMING_CONVENTION.md)

\- Test class naming: `{ClassUnderTest}Tests`

\- Test method naming: `{MethodName}_Should{Outcome}_{Condition}`

\- Use `#region` comments to group related tests

\- Mock fields use `_fieldNameMock` naming convention
